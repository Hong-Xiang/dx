...
class ColorBarItem(PlotItem):
    def __init__(self, start, span, img_item, image_scale=256.0 * 1.414, line_scale=100.0, label="10 mm", font_size=16, line_width=3.0, font_color='k', no_line=False, cbar_range=None, force_int=True, **kw):
