...
class TestTemplates(unittest.TestCase):
    def test_command(self):
        ...
        templates.os.popen = Mock()
        task.plan().subscribe()
        templates.os.popen.assert_called_with('cd /tmp/test && ls')
    ...
    def test_script(self):
        ...
        templates.os.popen = Mock()
        task.plan().subscribe()
        templates.os.popen.assert_called_with(
            'cd /tmp/test && /tmp/test/run.sh')
    ...
    def test_script_sbatch(self):
        ...
        task.plan(sbatch_command).subscribe()
        templates.os.popen.assert_called_with(
